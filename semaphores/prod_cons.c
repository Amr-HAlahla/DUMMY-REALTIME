...
#include <sys/ipc.h>
#include <sys/sem.h>
// #include <bits/sem.h>  /* This is needed for the definition of semun */
// #include <linux/sem.h> /* This is needed for the definition of semun */
...
main(int argc, char *argv[])
{
  ...
  pid_t c_pid;
  key_t ipc_key;
  static ushort start_val[2] = {1, 0}; /* Initial values of the semaphores */
  ...
  case 1:
    ...
    for (i = 0; i < 10; i++)
    {
      ...
      /* Wait for the consumer to read the number */
