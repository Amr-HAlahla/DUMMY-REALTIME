...
int main(int argc, char *argv[])
{
  ...
  i = 20 - sleep_limit; /* Number of strings to produce */
  ...
  while (i--)
  {
    ...
    acquire.sem_num = AVAIL_SLOTS; /* Wait for an available slot */
    ...
    release.sem_num = TO_CONSUME; /* Signal a string to consume */
